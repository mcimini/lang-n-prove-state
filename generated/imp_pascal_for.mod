...
typeOf Gamma EnvH (pascal_for E1 E2 E3 E4) (unitT) :- typeOf Gamma EnvH E1 (refH (int)), typeOf Gamma EnvH E2 (int), typeOf Gamma EnvH E3 (int), typeOf Gamma EnvH E4 (unitT).
...
step (pascal_for (labelH L) (num N1) (num N2) E) H (if (equal (deref (labelH L)) (num N2)) unit (seq E (seq (assign (labelH L) (plus (num N1) (num N1))) (pascal_for (labelH L) (num N1) (num N2) E)))) H.
