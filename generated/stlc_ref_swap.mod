...
typeOf Gamma EnvH (swap E1 E2) (unitT) :-
    typeOf Gamma EnvH E1 (refH T),
    typeOf Gamma EnvH E2 (refH T).
...
step (swap (labelH L1) (labelH L2)) MU1 unit MU1'' :- lookupMapH MU1 L1 V1, lookupMapH MU1 L2 V2, updateMapH MU1 L1 V2 MU1', updateMapH MU1' L2 V1 MU1'', value V1, value V2. 
...
step (swap E1 E2) MU1  (swap E1' E2) MU1' :- step E1 MU1  E1' MU1'.
step (swap E1 E2) MU1  (swap E1 E2') MU1' :- step E2 MU1  E2' MU1', value E1.
