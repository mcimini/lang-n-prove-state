...
typeOf Gamma EnvH (case1 E1 E2 E3 E8) (unitT) :- typeOf Gamma EnvH  E1 int, typeOf Gamma EnvH  E2  int, typeOf Gamma EnvH E3 (unitT), typeOf Gamma EnvH E8 (unitT). 
typeOf Gamma EnvH (case2 E1 E2 E3 E4 E5 E8) (unitT) :- typeOf Gamma EnvH  E1 int, typeOf Gamma EnvH  E2  int, typeOf Gamma EnvH E3 (unitT), typeOf Gamma EnvH  E4 int, typeOf Gamma EnvH E5 (unitT), typeOf Gamma EnvH E8 (unitT). 
typeOf Gamma EnvH (case3 E1 E2 E3 E4 E5 E6 E7 E8) (unitT) :- typeOf Gamma EnvH  E1 int, typeOf Gamma EnvH  E2 int, typeOf Gamma EnvH E3 (unitT), typeOf Gamma EnvH  E4 int, typeOf Gamma EnvH E5 (unitT), typeOf Gamma EnvH E6  int,typeOf Gamma EnvH  E7 (unitT), typeOf Gamma EnvH E8 (unitT). 
...
step (case1 V V1 E1 E) H (if (equal V V1) E1 E) H :- value V, value V1.
step (case2 V V1 E1 V2 E2 E) H (if (equal V V1) E1 (case1 V V2 E2 E)) H :- value V, value V1.
step (case3 V V1 E1 V2 E2 V3 E3 E) H (if (equal V V1) E1 (case2 V V2 E2 V3 E3 E)) H :- value V, value V1.
