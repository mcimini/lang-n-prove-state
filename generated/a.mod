...
typeOf Gamma EnvH EnvR (mallocInt Zd E1 E2) (unitT) :- 
	lookupEnvR EnvR Zd SomeT, 
	typeOf Gamma EnvH EnvR E1 int, 
	typeOf Gamma EnvH EnvR' E2 (unitT), 
	updateEnvR EnvR Zd (refH int) EnvR'.

typeOf Gamma EnvH EnvR (mallocLabel Zd E1 E2) (unitT) :- 
	lookupEnvR EnvR Zd SomeT, 
	typeOf Gamma EnvH EnvR E1 (refH T), 
	typeOf Gamma EnvH EnvR' E2 (unitT), 
	updateEnvR EnvR Zd (refH (refH T)) EnvR'.

typeOf Gamma EnvH EnvR (mallocCode Zd E1 E2) (unitT) :- 
	lookupEnvR EnvR Zd SomeT, 
	typeOf Gamma EnvH EnvR E1 (codeT EnvR''), 
	typeOf Gamma EnvH EnvR' E2 (unitT), 
	updateEnvR EnvR Zd (refH (refH (codeT EnvR''))) EnvR'.

typeOf Gamma EnvH EnvR (moveInt Zd E1 E2) (unitT) :- 
	lookupEnvR EnvR Zd SomeT, 
	typeOf Gamma EnvH EnvR E1 int, 
	typeOf Gamma EnvH EnvR' E2 (unitT), 
	updateEnvR EnvR Zd int EnvR'. 
	
typeOf Gamma EnvH EnvR (moveLabel Zd E1 E2) (unitT) :- 
	lookupEnvR EnvR Zd SomeT, 
	typeOf Gamma EnvH EnvR E1 (refH T), 
	typeOf Gamma EnvH EnvR' E2 (unitT), 
	updateEnvR EnvR Zd (refH T) EnvR'. 

typeOf Gamma EnvH EnvR (moveCode Zd E1 E2) (unitT) :- 
	lookupEnvR EnvR Zd SomeT, 
	typeOf Gamma EnvH EnvR E1 (codeT EnvR''), 
	typeOf Gamma EnvH EnvR' E2 (unitT), 
	updateEnvR EnvR Zd (codeT EnvR'') EnvR'. 
...
step (mallocInt Zd V E) H R E H' R' :- 
	addMapH H V H' LNewH, 
	updateMapR R Zd (labelH LNewH) R', 
	value (labelH LNewH). 

step (mallocLabel Zd V E) H R E H' R' :- 
	addMapH H V H' LNewH, 
	updateMapR R Zd (labelH LNewH) R', 
	value (labelH LNewH). 

step (mallocCode Zd V E) H R E H' R' :- 
	addMapH H V H' LNewH, 
	updateMapR R Zd (labelH LNewH) R', 
	value (labelH LNewH). 

step (moveInt Zd V E) H R E H R' :- 
	updateMapR R Zd V R', 
	value V. 

step (moveLabel Zd V E) H R E H R' :- 
	updateMapR R Zd V R', 
	value V. 

step (moveCode Zd V E) H R E H R' :- 
	updateMapR R Zd V R', 
	value V. 
