...
typeOf Gamma EnvH (pair E1 E2) (pairType T1 T2) :-
    typeOf Gamma EnvH E1 T1,
    typeOf Gamma EnvH E2 T2.

typeOf Gamma EnvH (doubleRef E1) (pairType (refH (refH T)) (refH T)) :- typeOf Gamma EnvH E1 T.
typeOf Gamma EnvH (doubleDeref E1) T :- typeOf Gamma EnvH E1 (refH (refH T)).
...
step (doubleRef V) MU1  (pair (labelH LNewH2) (labelH LNewH1)) MU2  :- addMapH MU1 V MU1' LNewH1, addMapH MU1' (labelH LNewH1) MU2 LNewH2, value V. 
step (doubleDeref (labelH GET1)) MU1  V MU1  :- lookupMapH MU1 GET1 (labelH GET2), lookupMapH MU1 GET2 V, value V. 


value (abs E1 E2).
value (unit).
value (labelH L).
value (pair V1 V2) :- value E1, value E2. 
