...
typeOf Gamma EnvH (realloc E1 E2 E3) (list (refH T)) :-
...
step (realloc V1 V2 (zero)) MU1  V1 MU1.
step (realloc V1 V2 (succ V)) MU1 (realloc (cons (labelH LNewH) V1) V2 V) MU1' :- addMapH MU1 V2 MU1' LNewH, value V1, value V2, value V.  
