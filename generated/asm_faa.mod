...
typeOf Gamma EnvH EnvR (faa Zd E1 E2 E3) (unitT) :- 
	lookupEnvR EnvR Zd (int), 
	typeOf Gamma EnvH EnvR E1 (refH (int)), 
	typeOf Gamma EnvH EnvR E2 (int), 
	typeOf Gamma EnvH EnvR' E3 (unitT), 
	updateEnvR EnvR Zd (int) EnvR'. 
...
step (faa Zd (labelH L) V2 E) H R E H' R' :- 
	lookupMapH H L V1, 
	addition V1 V2 V3, 
	updateMapH H L V3 H', 
	updateMapR R Zd V1 R', 
	value V1, 
	value V2, 
	value V3. 
