...
typeOf Gamma EnvH (foreach E R) (unitT) :- typeOf Gamma EnvH E (list T), (pi x\ typeOf (consEnvT x T1 Gamma) EnvH (R x) (unitT)).   
...
step (foreach (consL V1 V2) R) H (seq (R V1) (foreach V2 R)) H :- value V1, value V2.
...
step (foreach E1 E2) MU1  (foreach E1' E2) MU1' :- step E1 MU1  E1' MU1'.
