...
typeOf Gamma EnvH EnvM (assignAndRef E1 E2 E3) (unitT) :- typeOf Gamma EnvH EnvM E1 (refH T), typeOf Gamma EnvH EnvM E2 T, typeOf Gamma EnvH EnvM E3 T. 
...
step (refAndStore V) MU1 MU2 (pair (labelH LNewH) (pair (labelH LNewH2) (labelM LNewM))) MU1'' MU2' :- 
	addMapH MU1 V MU1' LNewH, 
	addMapM MU2 (labelH LNewH) MU2' LNewM, 
	addMapH MU1' (labelM LNewM) MU1'' LNewH2, 
	value V. 

step (assignAndRef (labelH L) V V2) H M (unit) H'' M'' :- 
	updateMapH H L V H',
	addMapH H' (labelH L) H'' LNewH,
	addMapM M V M' LNewM,
	updateMapM M' LNewM V2 M''. 	
...
step (assignAndRef E1 E2 E3) MU1 MU2 (assignAndRef E1' E2 E3) MU1' MU2' :- step E1 MU1 MU2 E1' MU1' MU2'.
step (assignAndRef E1 E2 E3) MU1 MU2 (assignAndRef E1 E2' E3) MU1' MU2' :- step E2 MU1 MU2 E2' MU1' MU2', value E1.
step (assignAndRef E1 E2 E3) MU1 MU2 (assignAndRef E1 E2 E3') MU1' MU2' :- step E3 MU1 MU2 E3' MU1' MU2', value E1, value E2.
