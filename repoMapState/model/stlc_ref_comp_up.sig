...
type doubleref term -> term.
type doublederef term -> term -> term.
type doubleassign term -> term -> term -> term.

type refAndStore term -> term.
type assignAndRef term -> term -> term -> term.
