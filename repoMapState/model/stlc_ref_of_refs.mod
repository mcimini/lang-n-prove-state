...
typeOf Gamma EnvH EnvM (refOfrefs E1) T :- typeOf Gamma EnvH EnvM E1 (refH (refH (refH (refH T)))). 
...
step (refOfrefs (labelH L)) MU1 MU2 V4 MU1 MU2 :- 
	lookupMapH MU1 L (labelH L1),
	lookupMapH MU1 L1 (labelH L2),
	lookupMapH MU1 L2 (labelH L3),
	lookupMapH MU1 L3 V4.
...
step (refOfrefs E1) MU1 MU2 (refOfrefs E1') MU1' MU2' :- step E1 MU1 MU2 E1' MU1' MU2'.
