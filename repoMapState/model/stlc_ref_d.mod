...
typeOf Gamma EnvH EnvM (doubleref E1) (times (refH T) (refM T)) :- typeOf Gamma EnvH EnvM E1 T.
typeOf Gamma EnvH EnvM (doublederef E1 E2) (times T1 T2) :- typeOf Gamma EnvH EnvM E1 (refH T1), typeOf Gamma EnvH EnvM E2 (refM T2).
typeOf Gamma EnvH EnvM (doubleassign E1 E2 E3) (unitT) :-
    typeOf Gamma EnvH EnvM E1 (refH T),
    typeOf Gamma EnvH EnvM E2 (refM T),
    typeOf Gamma EnvH EnvM E3 T.
...
step (doubleref V) MU1 MU2 (pair (labelH LNewH) (labelM LNewM)) MU1' MU2' :- addMapH MU1 V MU1' LNewH, addMapM MU2 V MU2' LNewM, value V. 
step (doublederef (labelH L1) (labelM L2)) MU1 MU2 (pair V1 V2) MU1 MU2 :- lookupMapH MU1 L1 V1, lookupMapM MU2 L2 V2, value V1, value V2. 
step (doubleassign (labelH L1) (labelM L2) V) MU1 MU2 unit MU1' MU2' :- updateMapH MU1 L1 V MU1', updateMapM MU2 L2 V MU2', value V.
...
step (doubleref E1) MU1 MU2 (doubleref E1') MU1' MU2' :- step E1 MU1 MU2 E1' MU1' MU2'.
step (doublederef E1 E2) MU1 MU2 (doublederef E1' E2) MU1' MU2' :- step E1 MU1 MU2 E1' MU1' MU2'.
step (doublederef E1 E2) MU1 MU2 (doublederef E1 E2') MU1' MU2' :- step E2 MU1 MU2 E2' MU1' MU2', value E1.
step (doubleassign E1 E2 E3) MU1 MU2 (doubleassign E1' E2 E3) MU1' MU2' :- step E1 MU1 MU2 E1' MU1' MU2'.
step (doubleassign E1 E2 E3) MU1 MU2 (doubleassign E1 E2' E3) MU1' MU2' :- step E2 MU1 MU2 E2' MU1' MU2', value E1.
step (doubleassign E1 E2 E3) MU1 MU2 (doubleassign E1 E2 E3') MU1' MU2' :- step E3 MU1 MU2 E3' MU1' MU2', value E1, value E2.

step (pair E1 E2) MU1 MU2 (pair E1' E2) MU1' MU2' :- step E1 MU1 MU2 E1' MU1' MU2'.
step (pair E1 E2) MU1 MU2 (pair E1 E2') MU1' MU2' :- step E2 MU1 MU2 E2' MU1' MU2', value E1.
